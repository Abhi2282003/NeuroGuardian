  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      id: "welcome",
      role: "assistant",
      content: "Namaste! 🙏 I'm your mental health companion. I'm here to support you with mindfulness techniques, coping strategies, and a listening ear. How are you feeling today?",
      timestamp: new Date(),
    },
  ]);
  ...
  return (
    <Card className="p-6 glass-card h-[600px] flex flex-col">
      ...
      <p className="text-xs text-muted-foreground text-center mt-2">
        🇮🇳 Multilingual support • Crisis detection • Mindfulness suggestions
      </p>
    </Card>
  );
}